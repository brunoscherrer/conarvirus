...
regions = {
    'China': ['Heilongjiang(China)', 'Henan(China)', 'Hubei(China)', 'Beijing(China)', 'Guangdong(China)', 'Shandong(China)', 'Chongqing(China)', 'Hainan(China)', 'Hebei(China)', 'Shanghai(China)', 'Hunan(China)', 'Shaanxi(China)', 'Sichuan(China)', 'Tianjin(China)', 'Xinjiang(China)', 'Anhui(China)', 'Hong Kong(China)', 'Jilin(China)'],
    ...
    'United Kingdom ': ['United Kingdom', 'Channel Islands(United Kingdom)', 'Isle of Man(United Kingdom)', 'Turks and Caicos Islands(United Kingdom)', 'Bermuda(United Kingdom)', 'Montserrat(United Kingdom)', 'Gibraltar(United Kingdom)'],
    'Netherlands ': ['Netherlands','Aruba(Netherlands)','Sint Maarten(Netherlands)','Bonaire, Sint Eustatius and Saba(Netherlands)','Curacao(Netherlands)'],
    ...
    'North America': [ 'Bahamas', 'Guatemala', 'US', 'Costa Rica', 'Nicaragua','Jamaica','Mexico', 'Trinidad and Tobago', 'Barbados',  'Antigua and Barbuda',  'Belize', 'Saint Lucia', 'Saint Vincent and the Grenadines'],
    ...
    for i in range(lk):
        ...
        for l in range(lg):
            ...
            if nl==6: # gr
                ...
                yy = (0, 2)#min(5, yy[1])) # don't go too high
